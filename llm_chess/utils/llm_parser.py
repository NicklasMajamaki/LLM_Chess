...
# from .results_dict import ResultsDict   # Going to need to make 'ParsedResultsDict'
...
class LLMParser():
    ...
    def __init__(self, args, task_map, wandb_run):
        ...
        self.dataclasses = [JSONLDataClass(args.data_dir, filename, task_map, model_version=None, data_format="model_response") for filename in args.data_files]
